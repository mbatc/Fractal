...
namespace Fractal
{
  ...
  public:
    ...
    void Construct(flIN const Colour* pPixels, flIN const Vec2I& size)
    {
    ...
    void Construct(flIN const ColourU32* pPixels, flIN const Vec2I& size)
    {
      m_pixels.insert(0, pPixels, pPixels + (int64_t)size.x * size.y);
    }

    void Construct(flIN const Vec2I& size, flIN ColourU32 initialColour = ColourU32_Black)
    {
    ...
    void Resize(flIN const Vec2I& size, flIN const SampleType sampleType)
    {
    ...
    ColourU32 Sample(flIN const Vec2F& uv, flIN const SampleType sampleType) const
    {
      switch (sampleType)
      {
