...
namespace Fractal
{
  ...
  void flCCONV Event_Create(flOUT Event *pEvent, flIN NativeEvent *pNativeEvent)
  {
    ...
    case WM_RBUTTONDOWN:  mouseDown = MB_Right; break;
    case WM_MBUTTONDOWN:  mouseDown = MB_Middle; break;
    case WM_XBUTTONDOWN:  mouseDown = 3; break;
    case WM_LBUTTONUP:    mouseUp = MB_Left; break;
    case WM_RBUTTONUP:    mouseUp = MB_Right; break;
    case WM_MBUTTONUP:    mouseUp = MB_Middle; break;
  ...
  static int64_t _TranslateKeyCode(int64_t winKey)
  {
    ...
    case VK_PAUSE:            return KC_PauseBreak;
    case VK_CAPITAL:          return KC_CapsLock;
    ...
    case VK_VOLUME_MUTE:      return KC_Mute;
    case VK_MEDIA_PLAY_PAUSE: return KC_PlayPause;
    case VK_MEDIA_NEXT_TRACK: return KC_NextTrack;
    case VK_MEDIA_PREV_TRACK: return KC_PrevTrack;
    case VK_MEDIA_STOP:       return KC_Stop;
    case VK_OEM_PLUS:         return KC_Equals;
    case VK_OEM_2:            return KC_ForwardSlash;
    case VK_OEM_1:            return KC_SemiColon;
    case VK_OEM_3:            return KC_Apostraphe;
    case VK_OEM_4:            return KC_OpenSqrBracket;
    case VK_OEM_5:            return KC_BackSlash;
    case VK_OEM_6:            return KC_CloseSqrBracket;
